...
- Existing one-shot guard, Broker authorization chain, SHA/ELF checks, revoke/watch, 60-second hard deadline, no-install policy and cleanup remain in the execution core.
